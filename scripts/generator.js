...
/**
 * Doc input info
 * @typedef {Object} DocInputInfo
 * @property {string} dirPath - The directory contains document.
 * @property {string} dirName - Directory name of `dirPath`.
 * @property {string} docPath - Mdx file path.
 * @property {string} configPath - Document config json file path.
 */
...
/**
 *
 * @param {string} dir Target directory to walk.
 * @returns {DocInputInfo}
 */
