...
export const mdxComponents: MDXComponents = {
  h1: ({ children, ...props }) => {
    ...
    return <h1 {...props} id={anchor}><_LinkIcon anchor={anchor}/>{title}</h1>
  },
  h2: ({ children, ...props }) => {
    const { title, anchor } = splitTitleAndAnchor(children as ReactNode)
    return <h2 {...props} id={anchor}><_LinkIcon anchor={anchor}/>{title}</h2>
  },
  h3: ({ children, ...props }) => {
    const { title, anchor } = splitTitleAndAnchor(children as ReactNode)
    return <h3 {...props} id={anchor}><_LinkIcon anchor={anchor}/>{title}</h3>
  },
  h4: ({ children, ...props }) => {
    const { title, anchor } = splitTitleAndAnchor(children as ReactNode)
    return <h4 {...props} id={anchor}><_LinkIcon anchor={anchor}/>{title}</h4>
  },
  h5: ({ children, ...props }) => {
    const { title, anchor } = splitTitleAndAnchor(children as ReactNode)
    return <h5 {...props} id={anchor}><_LinkIcon anchor={anchor}/>{title}</h5>
  },
  h6: ({ children, ...props }) => {
    const { title, anchor } = splitTitleAndAnchor(children as ReactNode)
    return <h6 {...props} id={anchor}><_LinkIcon anchor={anchor}/>{title}</h6>
  },
}